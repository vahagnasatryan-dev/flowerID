...
function appendGiftRequest(ss, record, receivedAt) {
  ...
  const valuesByHeader = {
    ...
    recipient_custom: payload.recipient_custom || "",
    occasion: payload.occasion || "",
    occasion_custom: payload.occasion_custom || "",
    desired_effect: payload.desired_effect || "",
    desired_effect_custom: payload.desired_effect_custom || "",
    taste_knowledge: payload.taste_knowledge || "",
    flower_id_link: payload.flower_id_link || "",
    taste_note: payload.taste_note || "",
    taste_style_hint: payload.taste_style_hint || "",
    taste_palette_hint: payload.taste_palette_hint || "",
    taste_format_hint: payload.taste_format_hint || "",
    avoid_items: join(payload.avoid_items),
    budget: payload.budget || "",
    recommended_style: payload.recommended_style || "",
    selected_option: payload.selected_option || "",
    selected_card_text: payload.selected_card_text || "",
    postcard_text: payload.postcard_text || "",
    telegram_contact: payload.telegram_contact || "",
